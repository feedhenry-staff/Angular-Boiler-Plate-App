      ...
      options: {
        middleware: function(connect, options, middlewares) {
          ...
          middlewares.unshift(function(req, res, next) {
            ...
            if (req.url !== '/box/srv/1.1/admin/authpolicy/auth') return next();
              //making auth call, send back successful response.
              //TODO provide option to use fhc to authenticate user against domain
              res.end('{"message":"Authentication successful","sessionToken":"mpbbq5guboa4ggkluqz4ipd4","status":"ok","userId":"phayes@redhat.com"}');
          });
